...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run deterministic heuristics for the technology diffusion experiment."
        )
    )
    ...
    parser.add_argument(
        "--results-csv-path",
        type=Path,
        default=RESULTS / "technology_diffusion_results_heuristics.csv",
    )
    parser.add_argument(
        "--static-params-path",
        type=Path,
        default=RESULTS / "technology_diffusion_static_params_heuristics.json",
    )
    parser.add_argument(
        "--run-label",
        type=str,
